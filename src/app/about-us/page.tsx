  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen">
      ...
      <div className="w-full flex flex-col gap-10 mt-14">
        ...
        <h2 className="text-xl text-gray-500 text-center font-semibold max-w-[60%] mx-auto">Dashing Distribution Software are the provider of the most comprehensive, electronic component distribution software, on the market today. Combining cutting edge technology, with timeless principles.</h2>
        <Carousel />
